...
msg1="Testing Fusion $modalities for $classification_type with learning rate $lr started on GPU $gpu_number"
msg2="Testing Fusion $modalities for $classification_type with learning rate $lr finished on GPU $gpu_number"
